    ...
    try {
        if (req.file) {
            ...
            if (!professionnel) {
                return res
                    .status(404)
                    .json({ error: "Professionnel not found" });
            }
...
exports.createProfessionnel = async (req, res) => {
    try {
        ...
        const exist = await Professionnel.findOne({
...
exports.addProfileProfessionnel = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findByIdAndUpdate(id, {
            profile: req.body,
        });
        if (req.file) {
...
exports.changeDetailleProfessionnel = async (req, res) => {
    try {
        ...
        if ("phone" in req.body) {
            ...
            pro = await Professionnel.findByIdAndUpdate(id, req.body, {
                new: true,
            });
        return res.status(201).json(pro);
    } catch (err) {
...
exports.addEmployment = async (req, res) => {
    try {
        ...
        if (employment) pro.profile.employments.push(employment);
        console.log(pro);
        await pro.save();
...
exports.modifyEmployment = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        if (employments) pro.profile.employments = employments;
        await pro.save();
        return res.status(201).json(pro);
    } catch (err) {
        return res.status(400).json(err);
...
exports.modifyEducation = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        if (Educations) pro.profile.educations = Educations;
        await pro.save();
        return res.status(201).json(pro);
    } catch (err) {
        return res.status(400).json(err);
...
exports.modifyExperience = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        if (Experiences) pro.profile.experiences = Experiences;
        await pro.save();
        return res.status(201).json(pro);
    } catch (err) {
        return res.status(400).json(err);
...
exports.suppEmployment = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        pro.profile.employments = await pro.profile.employments.filter(
            (employment) => employment._id != employmentId
        );
        await pro.save();
...
exports.suppEducation = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        pro.profile.educations = pro.profile.educations.filter(
...
exports.addExperience = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        if (experience) pro.profile.experiences.push(experience);
        await pro.save();
        return res.status(201).json(pro);
    } catch (err) {
        return res.status(400).json(err);
...
exports.suppExperience = async (req, res) => {
    try {
        ...
        const pro = await Professionnel.findById(id);
        pro.profile.experiences = pro.profile.experiences.filter(
