    ...
    return (
        ...
        >
            <APIProvider apiKey={GOOGLE_MAPS_API_KEY}>
                ...
                >
                    {showDirections && first && (
                        <Directions
                            origin={userLocationMarker}
                        ...
                        <>
                            ...
                            {UserLocationInfowindowOpen && (
                                <InfoWindow
                                    ...
                                    maxWidth={200}
                                    onCloseClick={() =>
                                        setUserLocationInfowindowOpen(false)
                                    }
                                >
                                    <p className="text-lg font-sans font-normal">
                                        Your location
...
function Directions({ origin, destination }) {
    ...
    useEffect(() => {
        ...
        const rendererOptions = {
            ...
            polylineOptions: {
                strokeColor: "#ff5400",
                strokeOpacity:
                    travelMode === google.maps.TravelMode.WALKING ? 0 : 1,
                icons:
    ...
    }, [routesLibrary, map, travelMode, origin]);
    ...
    }, [routeIndex, directionsRenderer, travelMode, origin]);
    ...
    return (
        <div className="h-fit max-w-80 absolute top-4 left-4  p-4 rounded-3xl backdrop-blur-sm shadow-[0_0px_20px_0px_rgba(0,0,0,0.15)]">
            <h2 className=" text-primary font-bold text-xl inline-block">
                Route:
            </h2>
        ...
        {leg.start_address.split(",")[0]} to {leg.end_address.split(",")[0]}
            ...
            <h2 className="text-primary font-bold text-xl mt-2">
                Other Routes:{" "}
            </h2>
            <ul>
